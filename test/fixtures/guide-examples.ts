...
// Re-exported so existing importers keep their path; the text lives in src/.
export { t2vaBakerExpected, i2vaTrainExpected, fl2vaUmbrellaExpected, l2vaGlassExpected } from '../../src/core/ir/examples';
